...
const checkboxUxSection = document.querySelector('.checkbox-ux')
const collapseList = checkboxUxSection.querySelectorAll('.collapse')
...
function toggleAllCheckbox(event) {
  ...
  const checkboxListInContent = this.querySelectorAll('.collapse-content input')
